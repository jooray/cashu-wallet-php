...
| `nut02-keyset-ids.json` | [cashubtc/nuts tests/02-tests.md] | keyset ID derivation (version 1) |
| `nut13-derivation.json` | [cashubtc/nuts tests/13-tests.md] | deterministic secret/blinding-factor derivation (version 1) |
...
Not covered because the library does not implement them: NUT-12 DLEQ
*verification* (DLEQ data is only stored/serialized), version-2 keyset IDs
(NUT-02/NUT-13 v2 vectors).
